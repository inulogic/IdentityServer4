...
namespace IdentityServer4.Extensions
{
    ...
    public static class TokenExtensions
    {
        ...
        /// </exception>
        public static string CreateJwtPayload(this Token token, ISystemClock clock, IdentityServerOptions options, ILogger logger)
        {
            ...
            try
            {
                ...
                // JwtPayload use Newtonsoft json serializer and JsonElement are not properly serialized
